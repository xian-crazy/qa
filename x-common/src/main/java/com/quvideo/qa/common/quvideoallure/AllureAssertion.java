...
public class AllureAssertion implements IAssertLifecycle {
    ...
    public void assertTrue(final boolean condition, final String message) {
        doAssert(new AllureAssertion.SimpleAssert<Boolean>(condition, Boolean.TRUE, message) {
            @Override
    ...
    public void assertTrue(final boolean condition) {
        doAssert(new AllureAssertion.SimpleAssert<Boolean>(condition, Boolean.TRUE) {
            @Override
            public void doAssert() {
    ...
    public void assertFalse(final boolean condition, final String message) {
        doAssert(new AllureAssertion.SimpleAssert<Boolean>(condition, Boolean.FALSE, message) {
            @Override
            public void doAssert() {
    ...
    public void assertFalse(final boolean condition) {
        doAssert(new AllureAssertion.SimpleAssert<Boolean>(condition, Boolean.FALSE) {
            @Override
            public void doAssert() {
    ...
    public void fail(final String message, final Throwable realCause) {
        doAssert(new AllureAssertion.SimpleAssert<Object>(message) {
            @Override
            public void doAssert() {
    ...
    public void fail() {
        doAssert(new AllureAssertion.SimpleAssert<Object>(null) {
            @Override
            public void doAssert() {
    ...
    public <T> void assertEquals(final T actual, final T expected, final String message) {
        doAssert(new AllureAssertion.SimpleAssert<T>(actual, expected, message) {
            @Override
            public void doAssert() {
    ...
    public <T> void assertEquals(final T actual, final T expected) {
        doAssert(new AllureAssertion.SimpleAssert<T>(actual, expected) {
            @Override
            public void doAssert() {
    ...
    public void assertEquals(final String actual, final String expected, final String message) {
        doAssert(new AllureAssertion.SimpleAssert<String>(actual, expected, message) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected, message);
            }
    ...
    public void assertEquals(final String actual, final String expected) {
        doAssert(new AllureAssertion.SimpleAssert<String>(actual, expected) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected);
            }
    ...
    public void assertEquals(final double actual, final double expected, final double delta,
        ...
        doAssert(new AllureAssertion.SimpleAssert<Double>(actual, expected, message) {
            @Override
            public void doAssert() {
    ...
    public void assertEquals(final double actual, final double expected, final double delta) {
        doAssert(new AllureAssertion.SimpleAssert<Double>(actual, expected) {
            @Override
            public void doAssert() {
    ...
    public void assertEquals(final float actual, final float expected, final float delta,
                             final String message) {
        doAssert(new AllureAssertion.SimpleAssert<Float>(actual, expected, message) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected, delta, message);
            }
    ...
    public void assertEquals(final float actual, final float expected, final float delta) {
        doAssert(new AllureAssertion.SimpleAssert<Float>(actual, expected) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected, delta);
            }
    ...
    public void assertEquals(final long actual, final long expected, final String message) {
        doAssert(new AllureAssertion.SimpleAssert<Long>(actual, expected, message) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected, message);
            }
    ...
    public void assertEquals(final long actual, final long expected) {
        doAssert(new AllureAssertion.SimpleAssert<Long>(actual, expected) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected);
            }
    ...
    public void assertEquals(final boolean actual, final boolean expected, final String message) {
        doAssert(new AllureAssertion.SimpleAssert<Boolean>(actual, expected, message) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected, message);
            }
    ...
    public void assertEquals(final boolean actual, final boolean expected) {
        doAssert(new AllureAssertion.SimpleAssert<Boolean>(actual, expected) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected);
            }
    ...
    public void assertEquals(final byte actual, final byte expected, final String message) {
        doAssert(new AllureAssertion.SimpleAssert<Byte>(actual, expected, message) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected, message);
            }
    ...
    public void assertEquals(final byte actual, final byte expected) {
        doAssert(new AllureAssertion.SimpleAssert<Byte>(actual, expected) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected);
            }
    ...
    public void assertEquals(final char actual, final char expected, final String message) {
        doAssert(new AllureAssertion.SimpleAssert<Character>(actual, expected, message) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected, message);
            }
    ...
    public void assertEquals(final char actual, final char expected) {
        doAssert(new AllureAssertion.SimpleAssert<Character>(actual, expected) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected);
            }
    ...
    public void assertEquals(final short actual, final short expected, final String message) {
        doAssert(new AllureAssertion.SimpleAssert<Short>(actual, expected, message) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected, message);
            }
    ...
    public void assertEquals(final short actual, final short expected) {
        doAssert(new AllureAssertion.SimpleAssert<Short>(actual, expected) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected);
            }
    ...
    public void assertEquals(final int actual, final int expected, final String message) {
        doAssert(new AllureAssertion.SimpleAssert<Integer>(actual, expected, message) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected, message);
            }
    ...
    public void assertEquals(final int actual, final int expected) {
        doAssert(new AllureAssertion.SimpleAssert<Integer>(actual, expected) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected);
            }
    ...
    public void assertNotNull(final Object object) {
        doAssert(new AllureAssertion.SimpleAssert<Object>(object, null) {
            @Override
            public void doAssert() {
    ...
    public void assertNotNull(final Object object, final String message) {
        doAssert(new AllureAssertion.SimpleAssert<Object>(object, null, message) {
            @Override
            public void doAssert() {
    ...
    public void assertSame(final Object actual, final Object expected, final String message) {
        doAssert(new AllureAssertion.SimpleAssert<Object>(actual, expected, message) {
            @Override
            public void doAssert() {
    ...
    public void assertSame(final Object actual, final Object expected) {
        doAssert(new AllureAssertion.SimpleAssert<Object>(actual, expected) {
            @Override
            public void doAssert() {
    ...
    public void assertEquals(final Collection<?> actual, final Collection<?> expected) {
        doAssert(new AllureAssertion.SimpleAssert<Collection<?>>(actual, expected) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected);
            }
    ...
    public void assertEquals(final Collection<?> actual, final Collection<?> expected,
                             final String message) {
        doAssert(new AllureAssertion.SimpleAssert<Collection<?>>(actual, expected, message) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected, message);
            }
    ...
    public void assertEquals(final Set<?> actual, final Set<?> expected) {
        doAssert(new AllureAssertion.SimpleAssert<Set<?>>(actual, expected) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected);
            }
    ...
    public void assertEquals(final Set<?> actual, final Set<?> expected, final String message) {
        doAssert(new AllureAssertion.SimpleAssert<Set<?>>(actual, expected, message) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected, message);
            }
    ...
    public void assertEquals(final Map<?, ?> actual, final Map<?, ?> expected) {
        doAssert(new AllureAssertion.SimpleAssert<Map<?, ?>>(actual, expected) {
            @Override
            public void doAssert() {
                org.testng.Assert.assertEquals(actual, expected);
            }
    ...
    abstract private static class SimpleAssert<T> implements IAssert<T> {
        ...
        public String toString() {
            String expectedmsg = null == this.expected ? "null" : this.expected.toString();
            String actualmsg = null == this.actual ? "null" : this.actual.toString();
            return "[预期值]" + expectedmsg + "  [实际值]" + actualmsg;
        }
